...
export default function DownloadContent() {
  ...
  return (
    ...
    <section style={{ "padding": "clamp(44px,7vw,80px) 0 40px" }}>
      ...
      <h1 style={{ "fontSize": "clamp(28px,6.2vw,48px)", "fontWeight": "900", "color": "#f3d391", "lineHeight": "1.3", "margin": "0 0 22px", "letterSpacing": "-0.015em" }}>همین‌جا بازی کن، یا میز را با خودت ببر</h1>
      <p style={{ "fontSize": "clamp(16px,2.2vw,19px)", "color": "#cdb797", "lineHeight": "2", "margin": "0 0 32px", "maxWidth": "640px" }}>لازم نیست چیزی نصب کنی — بازی مستقیم در مرورگر باز می‌شود. ولی اگر می‌خواهی همیشه دم دستت باشد، نسخه‌ی نصبی هم هست.</p>
      <button style={{ "background": "#d8ae44", "color": "#33100d", "fontWeight": "800", "fontSize": "18px", "padding": "17px 38px", "borderRadius": "11px", "border": "none", "cursor": "pointer", "fontFamily": "inherit", "boxShadow": "0 6px 24px rgba(216,174,68,0.18)" }}>بازی در مرورگر — بدون نصب</button>
    </section>
    ...
    <section style={{ "padding": "0 0 44px" }}>
      <div style={{ "background": "rgba(216,174,68,0.07)", "border": "1px solid rgba(232,193,105,0.25)", "borderRadius": "16px", "padding": "28px" }}>
        <p style={{ "fontSize": "17px", "color": "#e6d5b8", "margin": "0 0 18px" }}>به‌نظر می‌رسد از اندروید استفاده می‌کنید</p>
      ...
      <p style={{ "fontFamily": "ui-monospace, monospace", "fontSize": "13px", "color": "#9d7e69", "lineHeight": "1.9", "margin": "14px 0 0" }}>همین کادر برای ویندوز، مک و لینوکس با متن متناسب. اگر تشخیص ممکن نبود، فهرست کامل نمایش داده شود.</p>
    </section>
    ...
    <section style={{ "padding": "44px 0", "borderTop": "1px solid rgba(232,193,105,0.13)" }}>
      ...
      <div style={{ "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(min(280px,100%),1fr))", "gap": "18px" }}>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "14px", "padding": "24px" }}>
          ...
          <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.9", "margin": "0 0 18px" }}>فایل نصبی را بگیرید و نصب کنید. به‌روزرسانی‌های بعدی از داخل خود برنامه انجام می‌شود.</p>
        ...
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "14px", "padding": "24px" }}>
          ...
          <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.9", "margin": "0" }}>بدون دانلود هیچ فایلی، بازی را روی صفحه‌ی اصلی گوشی‌تان بگذارید. در مرورگر، از منو «افزودن به صفحه‌ی اصلی» را بزنید.</p>
        </div>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "14px", "padding": "24px" }}>
    ...
    <section style={{ "padding": "44px 0", "borderTop": "1px solid rgba(232,193,105,0.13)" }}>
      ...
      <p style={{ "fontSize": "17px", "color": "#cdb797", "lineHeight": "2", "margin": "0 0 22px" }}>اگر اولین بار است که فایل نصبی را خارج از فروشگاه نصب می‌کنید، اندروید یک هشدار نشان می‌دهد. طبیعی است:</p>
      <ol style={{ "margin": "0 0 26px", "paddingInlineStart": "22px", "fontSize": "17px", "color": "#cdb797", "lineHeight": "2.2" }}>
        <li>فایل را دانلود کنید.</li>
        <li>روی فایل دانلودشده بزنید.</li>
        <li>اگر پیام «نصب برنامه‌های ناشناس» آمد، اجازه را برای مرورگرتان فعال کنید.</li>
        <li>«نصب» را بزنید. تمام.</li>
      </ol>
    ...
    <section style={{ "padding": "44px 0", "borderTop": "1px solid rgba(232,193,105,0.13)" }}>
      <h2 style={{ "fontSize": "clamp(19px,3vw,24px)", "fontWeight": "800", "color": "#e8c169", "margin": "0 0 20px" }}>به‌زودی در فروشگاه‌ها</h2>
    ...
    <section style={{ "padding": "44px 0 56px", "borderTop": "1px solid rgba(232,193,105,0.13)" }}>
      ...
      <div style={{ "display": "grid", "gap": "22px" }}>
        <div><h3 style={{ "fontSize": "17px", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 8px" }}>نسخه‌ی مرورگر با نسخه‌ی نصبی فرق دارد؟</h3><p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>نه. همان بازی است، با همان حساب کاربری و همان رتبه. فقط نسخه‌ی نصبی سریع‌تر باز می‌شود و آفلاین هم کار می‌کند.</p></div>
        <div><h3 style={{ "fontSize": "17px", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 8px" }}>اگر برنامه را نصب کنم، حسابم منتقل می‌شود؟</h3><p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>بله. با همان حساب وارد شوید، تاریخچه و رتبه‌تان سر جایش است.</p></div>
        <div><h3 style={{ "fontSize": "17px", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 8px" }}>به‌روزرسانی چطور انجام می‌شود؟</h3><p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>نسخه‌ی دانلود مستقیم خودش خبر می‌دهد و از داخل برنامه به‌روز می‌شود.</p></div>
        <div><h3 style={{ "fontSize": "17px", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 8px" }}>حجمش چقدر است؟</h3><p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>حدود ۴۰ مگابایت برای اندروید.</p></div>
        <div><h3 style={{ "fontSize": "17px", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 8px" }}>بازی رایگان است؟</h3><p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>بله، و رایگان می‌ماند.</p></div>
      </div>
    </section>
  </main>
    </>

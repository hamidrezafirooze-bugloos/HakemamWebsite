...
export default function BebeRulesContent() {
  ...
  return (
    ...
    <section style={{ "padding": "0 0 44px" }}>
      ...
      <div style={{ "display": "grid", "gap": "14px" }}>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "12px", "padding": "20px" }}>
          <p style={{ "fontSize": "17px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}><strong style={{ "color": "#f3d391" }}>۱.</strong> بازیکن‌ها به نوبت (ساعت‌گرد) از بالای دسته‌ی خودشان یک کارت برمی‌دارند و رو به بالا وسط میز می‌گذارند.</p>
        </div>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "12px", "padding": "20px" }}>
          <p style={{ "fontSize": "17px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}><strong style={{ "color": "#f3d391" }}>۲.</strong> کارت‌های عددی — از ۲ تا ۱۰ — هیچ واکنشی لازم ندارند. فقط گذاشته می‌شوند و نوبت به نفر بعد می‌رسد.</p>
        </div>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "12px", "padding": "20px" }}>
          <p style={{ "fontSize": "17px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}><strong style={{ "color": "#f3d391" }}>۳.</strong> اما اگر کارتِ گذاشته‌شده آس، شاه، بی‌بی یا سرباز باشد، همه‌ی بازیکن‌ها باید بلافاصله واکنش مربوط به آن را انجام دهند.</p>
        </div>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "12px", "padding": "20px" }}>
          <p style={{ "fontSize": "17px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}><strong style={{ "color": "#f3d391" }}>۴.</strong> آخرین نفری که واکنش را انجام می‌دهد — یا کسی که واکنش اشتباه انجام می‌دهد — همه‌ی کارت‌های وسط میز را برمی‌دارد و به ته دسته‌ی خودش اضافه می‌کند.</p>
        </div>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "12px", "padding": "20px" }}>
          <p style={{ "fontSize": "17px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}><strong style={{ "color": "#f3d391" }}>۵.</strong> بازی ادامه پیدا می‌کند تا وقتی که یکی دستش خالی شود.</p>
        </div>
      </div>
    </section>

    <section style={{ "padding": "0 0 44px" }}>
      <h2 style={{ "fontSize": "clamp(21px,3.8vw,28px)", "fontWeight": "800", "color": "#e8c169", "margin": "0 0 20px" }}>چهار واکنش</h2>
    ...
    <section style={{ "padding": "0 0 44px" }}>
      <h2 style={{ "fontSize": "clamp(21px,3.8vw,28px)", "fontWeight": "800", "color": "#e8c169", "margin": "0 0 20px" }}>در بازی آنلاین چه فرقی دارد؟</h2>
    ...
    <section style={{ "padding": "0 0 44px" }}>
      ...
      <ul style={{ "margin": "0 0 18px", "paddingInlineStart": "22px", "fontSize": "17px", "color": "#cdb797", "lineHeight": "2.1" }}>
        <li>۷ خشت — همه باید ساکت شوند تا نفر بعد کارت بگذارد</li>
        <li>دو کارت هم‌ارزش پشت سر هم — همه دست روی کارت می‌گذارند، مثل آس</li>
        <li>کارت با خال دل — همه دست روی قلبشان می‌گذارند</li>
      </ul>
    ...
    <section style={{ "padding": "0 0 44px" }}>
      <div style={{ "background": "rgba(216,174,68,0.07)", "border": "1px solid rgba(232,193,105,0.25)", "borderRadius": "16px", "padding": "28px" }}>
        <h2 style={{ "fontSize": "clamp(19px,3vw,24px)", "fontWeight": "800", "color": "#e8c169", "margin": "0 0 16px" }}>در جمع شما چطور بازی می‌شود؟</h2>
    ...
    <section style={{ "padding": "0 0 44px" }}>
      ...
      <div style={{ "display": "grid", "gap": "14px" }}>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "12px", "padding": "20px" }}>
          <p style={{ "fontSize": "17px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}><strong style={{ "color": "#f3d391" }}>۱. نگاه کردن به کارت‌های خودتان.</strong> کارت‌ها رو به پایین می‌مانند. هیچ‌کس نباید بداند چه دارد.</p>
        </div>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "12px", "padding": "20px" }}>
          <p style={{ "fontSize": "17px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}><strong style={{ "color": "#f3d391" }}>۲. فکر کردن اینکه فقط کسی که کارت گذاشته باید واکنش بدهد.</strong> همه باید. این پرتکرارترین اشتباه شب اول است.</p>
        </div>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "12px", "padding": "20px" }}>
          <p style={{ "fontSize": "17px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}><strong style={{ "color": "#f3d391" }}>۳. واکنش دادن به کارت اشتباه.</strong> واکنش زودهنگام هم خطاست. اگر روی یک ۹ دست بگذارید، کارت‌ها مال شماست.</p>
        </div>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "12px", "padding": "20px" }}>
          <p style={{ "fontSize": "17px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}><strong style={{ "color": "#f3d391" }}>۴. کند گذاشتن کارت.</strong> بعضی‌ها برای اینکه آماده‌تر باشند، کارتشان را آهسته می‌گذارند. این بازی را کسل‌کننده می‌کند. کارت باید سریع و در یک حرکت گذاشته شود.</p>
        </div>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "12px", "padding": "20px" }}>
          <p style={{ "fontSize": "17px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}><strong style={{ "color": "#f3d391" }}>۵. توافق نکردن روی واکنش‌ها پیش از شروع.</strong> اگر نیمی از میز برای سرباز می‌خندند و نیمی سلام نظامی می‌دهند، دعوا حتمی است. سی ثانیه اول را صرف توافق کنید.</p>
        </div>
      </div>
    </section>

...
export default function HokmRulesContent() {
  ...
  return (
    ...
    <section style={{ "padding": "clamp(44px,7vw,80px) 0 40px" }}>
      <p style={{ "fontSize": "14px", "fontWeight": "700", "letterSpacing": "0.14em", "color": "#b8905a", "margin": "0 0 20px" }}>قوانین حکم</p>
    ...
    <div style={{ "background": "rgba(216,174,68,0.07)", "border": "1px solid rgba(232,193,105,0.25)", "borderRadius": "16px", "padding": "28px", "marginBottom": "44px" }}>
      <h2 style={{ "fontSize": "15px", "fontWeight": "800", "letterSpacing": "0.1em", "color": "#d8ae44", "margin": "0 0 20px" }}>خلاصه‌ی سریع</h2>
      <div style={{ "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(200px,1fr))", "gap": "18px 26px", "marginBottom": "24px" }}>
      ...
      <button style={{ "background": "#d8ae44", "color": "#33100d", "fontWeight": "800", "fontSize": "16px", "padding": "15px 30px", "borderRadius": "10px", "border": "none", "cursor": "pointer", "fontFamily": "inherit" }}>همین حالا یک دست بازی کن — بدون نصب</button>
    </div>

    <section style={{ "padding": "0 0 44px" }}>
      <h2 style={{ "fontSize": "clamp(21px,3.8vw,28px)", "fontWeight": "800", "color": "#e8c169", "margin": "0 0 20px" }}>چه چیزی لازم داری</h2>
      <ul style={{ "margin": "0 0 20px", "paddingInlineStart": "22px", "fontSize": "17px", "color": "#cdb797", "lineHeight": "2.1" }}>
        <li>یک دست کارت پاسور ۵۲ برگی (جوکرها کنار گذاشته می‌شوند)</li>
        <li>چهار بازیکن</li>
      </ul>
    ...
    <section style={{ "padding": "0 0 44px" }}>
      <h2 style={{ "fontSize": "clamp(21px,3.8vw,28px)", "fontWeight": "800", "color": "#e8c169", "margin": "0 0 20px" }}>انتخاب حاکم</h2>
    ...
    <section style={{ "padding": "0 0 44px" }}>
      <h2 style={{ "fontSize": "clamp(21px,3.8vw,28px)", "fontWeight": "800", "color": "#e8c169", "margin": "0 0 20px" }}>پخش کارت و انتخاب حکم</h2>
    ...
    <section style={{ "padding": "0 0 44px" }}>
      <h2 style={{ "fontSize": "clamp(21px,3.8vw,28px)", "fontWeight": "800", "color": "#e8c169", "margin": "0 0 20px" }}>بازی کردن یک دست</h2>
      ...
      <ul style={{ "margin": "0 0 16px", "paddingInlineStart": "22px", "fontSize": "17px", "color": "#cdb797", "lineHeight": "2.1" }}>
        <li>اگر حکمی در دست بازی شده باشد، بالاترین حکم برنده است</li>
        <li>اگر حکمی بازی نشده باشد، بالاترین کارت از خالِ شروع‌شده برنده است</li>
      </ul>
      <p style={{ "fontSize": "17px", "color": "#cdb797", "lineHeight": "2", "margin": "0" }}>برنده‌ی هر دست، دست بعدی را شروع می‌کند.</p>
    </section>

    <section style={{ "padding": "0 0 44px" }}>
      <h2 style={{ "fontSize": "clamp(21px,3.8vw,28px)", "fontWeight": "800", "color": "#e8c169", "margin": "0 0 20px" }}>امتیازدهی و کوت</h2>
      ...
      <ul style={{ "margin": "0 0 16px", "paddingInlineStart": "22px", "fontSize": "17px", "color": "#cdb797", "lineHeight": "2.1" }}>
        <li>اگر تیم حاکم آن دست را برده باشد، حاکم حاکم می‌ماند و همان نفر دوباره پخش می‌کند.</li>
        <li>اگر تیم مقابل برده باشد، حاکمی به تیم مقابل منتقل می‌شود.</li>
      </ul>
    ...
    <section style={{ "padding": "0 0 44px" }}>
      <h2 style={{ "fontSize": "clamp(21px,3.8vw,28px)", "fontWeight": "800", "color": "#e8c169", "margin": "0 0 20px" }}>حالت‌های بدون حکم: سرس، نرس و آس نرس</h2>
      ...
      <h3 style={{ "fontSize": "clamp(17px,2.4vw,20px)", "fontWeight": "800", "color": "#f3d391", "margin": "0 0 14px" }}>سرس</h3>
      ...
      <h3 style={{ "fontSize": "clamp(17px,2.4vw,20px)", "fontWeight": "800", "color": "#f3d391", "margin": "0 0 14px" }}>نرس</h3>
      ...
      <h3 style={{ "fontSize": "clamp(17px,2.4vw,20px)", "fontWeight": "800", "color": "#f3d391", "margin": "0 0 14px" }}>آس نرس</h3>
    ...
    <section style={{ "padding": "0 0 44px" }}>
      <h2 style={{ "fontSize": "clamp(21px,3.8vw,28px)", "fontWeight": "800", "color": "#e8c169", "margin": "0 0 20px" }}>واریانت‌های منطقه‌ای و خانگی</h2>
      ...
      <div style={{ "background": "rgba(216,174,68,0.07)", "border": "1px solid rgba(232,193,105,0.25)", "borderRadius": "14px", "padding": "24px", "display": "flex", "gap": "18px", "alignItems": "center", "flexWrap": "wrap" }}>
    ...
    <section style={{ "padding": "0 0 44px" }}>
      <h2 style={{ "fontSize": "clamp(21px,3.8vw,28px)", "fontWeight": "800", "color": "#e8c169", "margin": "0 0 20px" }}>اشتباه‌های رایج تازه‌کارها</h2>
    ...
    <section style={{ "padding": "0 0 56px" }}>
      ...
      <ul style={{ "margin": "0", "paddingInlineStart": "22px", "fontSize": "17px", "color": "#cdb797", "lineHeight": "2.1" }}>
        <li><strong style={{ "color": "#f3d391" }}>شلم</strong> — بازی چهارنفره با اعلام امتیاز</li>
        <li><strong style={{ "color": "#f3d391" }}>بی‌بی‌سلام</strong> — سبک‌تر و مناسب دورهمی خانوادگی</li>
      </ul>
    </section>
  </main>
    </>

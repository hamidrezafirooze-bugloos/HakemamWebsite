...
export default function HomeContent() {
  ...
  return (
    ...
    <div style={{ "position": "relative", "maxWidth": "1120px", "margin": "0 auto", "padding": "clamp(48px,7vw,88px) clamp(16px,4vw,24px) clamp(36px,5vw,56px)" }}>
      ...
      <h1 style={{ "fontSize": "clamp(30px,7.2vw,58px)", "fontWeight": "900", "color": "#f3d391", "lineHeight": "1.28", "margin": "0 0 22px", "maxWidth": "800px", "letterSpacing": "-0.015em", "textWrap": "pretty" }}>اینجا معلوم می‌شود کی بهتر بازی می‌کند</h1>
      ...
      <div style={{ "display": "flex", "gap": "14px", "flexWrap": "wrap", "alignItems": "center" }}>
        <a href="https://hakem.am/" style={{ "background": "#d8ae44", "color": "#33100d", "fontWeight": "800", "fontSize": "18px", "padding": "17px 38px", "borderRadius": "11px", "border": "none", "cursor": "pointer", "fontFamily": "inherit", "boxShadow": "0 6px 24px rgba(216,174,68,0.18)", "textDecoration": "none", "display": "inline-block" }}>شروع بازی</a>
      ...
      <p style={{ "fontSize": "15px", "color": "#b0907a", "margin": "28px 0 0" }}>آخرین دست: ۴ دقیقه پیش · امشب ساعت ۲۱ شلوغ‌ترین ساعت است</p>
    </div>
    </section>
      ...
      <div style={{ "display": "flex", "flexWrap": "wrap", "gap": "20px", "perspective": "1400px" }}>
        ...
        <div style={{ "width": "244px", "height": "342px", "position": "relative", "transformStyle": "preserve-3d", "transition": "transform 0.65s cubic-bezier(0.2,0.7,0.25,1)", "cursor": "pointer" }} className="hv1">
          ...
          <div style={{ "position": "absolute", "inset": "0", "backfaceVisibility": "hidden", "transform": "rotateY(180deg)", "borderRadius": "16px", "background": "linear-gradient(160deg,#3a1a13,#25100c)", "border": "1px solid rgba(232,193,105,0.3)", "boxShadow": "0 14px 38px rgba(0,0,0,0.45)", "padding": "28px 24px", "display": "flex", "flexDirection": "column", "justifyContent": "center", "gap": "16px" }}>
            ...
            <p style={{ "fontSize": "16px", "color": "#dcc6a6", "lineHeight": "1.95", "margin": "0" }}>بازی اصلی. چهارنفره، دو تیم، و همان خالِ برنده‌ای که سرش بحث می‌شود.</p>
        ...
        <div style={{ "width": "244px", "height": "342px", "position": "relative", "transformStyle": "preserve-3d", "transition": "transform 0.65s cubic-bezier(0.2,0.7,0.25,1)", "cursor": "pointer" }} className="hv1">
          ...
          <div style={{ "position": "absolute", "inset": "0", "backfaceVisibility": "hidden", "transform": "rotateY(180deg)", "borderRadius": "16px", "background": "linear-gradient(160deg,#3a1a13,#25100c)", "border": "1px solid rgba(232,193,105,0.3)", "boxShadow": "0 14px 38px rgba(0,0,0,0.45)", "padding": "28px 24px", "display": "flex", "flexDirection": "column", "justifyContent": "center", "gap": "16px" }}>
            ...
            <p style={{ "fontSize": "16px", "color": "#dcc6a6", "lineHeight": "1.95", "margin": "0" }}>سنگین‌تر و رقابتی‌تر، با اعلام امتیاز. برای وقتی که حکم برایت ساده شده.</p>
            <div style={{ "display": "flex", "gap": "16px" }}><span style={{ "border": "1px solid rgba(232,193,105,0.4)", "color": "#c9a469", "fontSize": "13px", "fontWeight": "700", "padding": "6px 14px", "borderRadius": "999px" }}>به زودی</span></div>
          </div>
        </div>
        ...
        <div style={{ "width": "244px", "height": "342px", "position": "relative", "transformStyle": "preserve-3d", "transition": "transform 0.65s cubic-bezier(0.2,0.7,0.25,1)", "cursor": "pointer" }} className="hv1">
          ...
          <div style={{ "position": "absolute", "inset": "0", "backfaceVisibility": "hidden", "transform": "rotateY(180deg)", "borderRadius": "16px", "background": "linear-gradient(160deg,#3a1a13,#25100c)", "border": "1px solid rgba(232,193,105,0.3)", "boxShadow": "0 14px 38px rgba(0,0,0,0.45)", "padding": "28px 24px", "display": "flex", "flexDirection": "column", "justifyContent": "center", "gap": "16px" }}>
            ...
            <p style={{ "fontSize": "16px", "color": "#dcc6a6", "lineHeight": "1.95", "margin": "0" }}>کهن‌ترین بازی ورق ایرانی، با کارت‌های نگارگری‌شده و قواعدی که ریشه در دوران صفوی دارد.</p>
            <div style={{ "display": "flex", "gap": "16px" }}><span style={{ "border": "1px solid rgba(232,193,105,0.4)", "color": "#c9a469", "fontSize": "13px", "fontWeight": "700", "padding": "6px 14px", "borderRadius": "999px" }}>به زودی</span></div>
          </div>
        </div>

      </div>
      <p style={{ "fontSize": "15px", "color": "#b0907a", "margin": "22px 0 0" }}>بازی‌های بیشتری در راه است.</p>
      </div>
    </section>
    ...
    <section style={{ "position": "relative", "borderTop": "1px solid rgba(232,193,105,0.13)" }}>
      ...
      <div style={{ "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(min(280px,100%),1fr))", "gap": "32px" }}>
        <div>
          <h3 style={{ "fontSize": "clamp(16px,2.2vw,19px)", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 12px" }}>رتبه‌ای که واقعاً معنا دارد</h3>
          <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>همه ادعا می‌کنند خوب بازی می‌کنند. اینجا معلوم می‌شود. بعد از هر بازی کیفیت تصمیم‌هایت سنجیده می‌شود، نه فقط برد و باخت — چون در این بازی‌ها شانس هم نقش دارد.</p>
        </div>
        <div>
          <h3 style={{ "fontSize": "clamp(16px,2.2vw,19px)", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 12px" }}>بدون مانع</h3>
          <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>در مرورگر باز می‌شود و بازی شروع می‌شود. کد اتاق را بفرست، رفقایت بدون هیچ دردسری می‌آیند تو.</p>
        </div>
        <div>
          <h3 style={{ "fontSize": "clamp(16px,2.2vw,19px)", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 12px" }}>چیزی بیشتر از یک میز</h3>
          <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>بازی پر از چیزهایی است که می‌شود کشف و جمعشان کرد — کارت‌هایی با چهره‌های آشنای این سرزمین، و آنچه دور میز حال می‌دهد.</p>
        </div>
      </div>
      </div>
    </section>
    ...
    <section style={{ "position": "relative" }}>
      ...
      <div style={{ "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(min(240px,100%),1fr))", "gap": "18px" }}>
        ...
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "14px", "padding": "24px", "opacity": "0", "animation": "stepRise 0.75s cubic-bezier(0.2,0.75,0.25,1) 0.16s both, stepGlow 4.5s ease-in-out 1.80s infinite", "transition": "transform 0.35s cubic-bezier(0.2,0.75,0.25,1),border-color 0.35s,background 0.35s" }} className="hv2">
          ...
          <p style={{ "fontSize": "16px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}>لینک را بفرست — در تلگرام یا واتساپ</p>
        </div>
        <div style={{ "background": "rgba(16,4,4,0.72)", "border": "1px solid rgba(232,193,105,0.32)", "borderRadius": "14px", "padding": "24px", "opacity": "0", "animation": "stepRise 0.75s cubic-bezier(0.2,0.75,0.25,1) 0.24s both, stepGlow 4.5s ease-in-out 2.20s infinite", "transition": "transform 0.35s cubic-bezier(0.2,0.75,0.25,1),border-color 0.35s,background 0.35s" }} className="hv2">
          ...
          <p style={{ "fontSize": "16px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}>بازی کن — به محض چهار نفر شدن، میز شروع می‌شود</p>
        </div>
      </div>
    ...
    <section style={{ "maxWidth": "1120px", "margin": "0 auto", "padding": "clamp(44px,6vw,72px) clamp(16px,4vw,24px) clamp(28px,4vw,40px)" }}>
      ...
      <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0 0 18px", "maxWidth": "620px" }}>در مرورگر بازی کن، یا برنامه را بگیر و همیشه دم دستت داشته باش. اندروید، ویندوز، مک و لینوکس.</p>
    ...
    <section style={{ "maxWidth": "1120px", "margin": "0 auto", "padding": "clamp(44px,6vw,72px) clamp(16px,4vw,24px)" }}>
      ...
      <div style={{ "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(min(320px,100%),1fr))", "gap": "26px" }}>
        <div>
          <h3 style={{ "fontSize": "17px", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 8px" }}>حاکمم چیست؟</h3>
          <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>جایی برای بازی آنلاین بازی‌های ورق ایرانی — حکم، شلم و بی‌بی‌سلام — با دوستانتان یا با حریف هوشمند.</p>
        </div>
        <div>
          <h3 style={{ "fontSize": "17px", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 8px" }}>رایگان است؟</h3>
          <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>بله. بازی کردن رایگان است و رایگان می‌ماند.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>نه. مستقیم در مرورگر باز می‌شود. نسخه‌ی نصبی هم هست.</p>
        </div>
        <div>
          <h3 style={{ "fontSize": "17px", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 8px" }}>می‌توانم فقط با دوستان خودم بازی کنم؟</h3>
          <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>بله. اتاق خصوصی بسازید و کدش را فقط برای همان‌ها بفرستید.</p>
        </div>
        <div>
          <h3 style={{ "fontSize": "17px", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 8px" }}>بازی‌های دیگری هم اضافه می‌شود؟</h3>

...
export default function ShelemGameContent() {
  ...
  return (
    ...
    <div style={{ "position": "absolute", "inset": "0", "backgroundImage": "linear-gradient(270deg,rgba(24,6,5,0.86) 0%,rgba(24,6,5,0.66) 42%,rgba(24,6,5,0.3) 100%),url('/assets/shelem-hero-bg.webp')", "backgroundSize": "cover", "backgroundPosition": "center" }}></div>
    <div style={{ "position": "relative", "maxWidth": "1120px", "margin": "0 auto", "padding": "clamp(48px,7vw,88px) clamp(16px,4vw,24px) clamp(36px,5vw,56px)" }}>
      ...
      <p style={{ "fontSize": "clamp(17px,2.5vw,21px)", "color": "#d8c2a4", "lineHeight": "1.85", "margin": "0 0 38px", "maxWidth": "640px", "textWrap": "pretty" }}>اعلام کن، حکم رو انتخاب کن، و ببین به عددت می‌رسی یا می‌سوزی. حساب امتیازها با ماست.</p>
    ...
    <section style={{ "maxWidth": "1120px", "margin": "0 auto", "padding": "clamp(36px,5vw,56px) clamp(16px,4vw,24px)", "borderTop": "1px solid rgba(232,193,105,0.13)" }}>
      ...
      <div style={{ "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(min(320px,100%),1fr))", "gap": "18px" }}>
        <div style={{ "backgroundImage": "linear-gradient(rgba(20,6,5,0.44),rgba(20,6,5,0.45)),url('/assets/shelem-reason-1.webp')", "backgroundSize": "cover", "backgroundPosition": "center", "border": "1px solid rgba(232,193,105,0.32)", "borderRadius": "16px", "padding": "28px" }}>
          <h3 style={{ "fontSize": "clamp(17px,2.5vw,21px)", "fontWeight": "800", "color": "#f3d391", "margin": "0 0 14px" }}>امتیاز رو ما می‌شماریم</h3>
          <p style={{ "fontSize": "16px", "color": "#FFF3E2", "lineHeight": "1.95", "margin": "0", "textShadow": "0 1px 3px rgba(0,0,0,0.75)" }}>در شلم آخر هر دست باید امتیاز کارت‌های برده‌شده رو جمع بزنین — و همین‌جاست که بحث شروع میشه. اینجا شمارش خودکاره: امتیاز کارت‌ها، امتیاز دست‌ها، آخری، و سوختن، همه بی‌خطا حساب میشن.</p>
        </div>
        <div style={{ "backgroundImage": "linear-gradient(rgba(20,6,5,0.44),rgba(20,6,5,0.45)),url('/assets/shelem-reason-2.webp')", "backgroundSize": "cover", "backgroundPosition": "center", "border": "1px solid rgba(232,193,105,0.32)", "borderRadius": "16px", "padding": "28px" }}>
          <h3 style={{ "fontSize": "clamp(17px,2.5vw,21px)", "fontWeight": "800", "color": "#f3d391", "margin": "0 0 14px" }}>قاعده‌های میز خودتون</h3>
          <p style={{ "fontSize": "16px", "color": "#FFF3E2", "lineHeight": "1.95", "margin": "0", "textShadow": "0 1px 3px rgba(0,0,0,0.75)" }}>آس ۱۰ یا ۱۵؟ جوکر دارین یا نه؟ امتیاز پایان بازی ۱۱۰۰ یا ۱۶۵۰؟ پیش از شروع میز، قاعده‌ها رو همون‌طور که در جمع خودتون بازی می‌کنین تنظیم کنین.</p>
        </div>
      </div>
    </section>

    <section style={{ "position": "relative", "backgroundImage": "linear-gradient(rgba(20,6,5,0.36),rgba(20,6,5,0.38)),url('/assets/shelem-howto-bg.webp')", "backgroundSize": "cover", "backgroundPosition": "center", "borderTop": "1px solid rgba(232,193,105,0.24)", "borderBottom": "1px solid rgba(232,193,105,0.24)" }}>
      ...
      <div style={{ "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(min(240px,100%),1fr))", "gap": "18px" }}>
        ...
        <div style={{ "background": "rgba(16,4,4,0.72)", "border": "1px solid rgba(232,193,105,0.32)", "borderRadius": "14px", "padding": "24px", "opacity": "0", "animation": "stepRise 0.75s cubic-bezier(0.2,0.75,0.25,1) 0.16s both, stepGlow 4.5s ease-in-out 1.80s infinite", "transition": "transform 0.35s cubic-bezier(0.2,0.75,0.25,1),border-color 0.35s,background 0.35s" }} className="hv1">
          ...
          <p style={{ "fontSize": "16px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}>قاعده‌ها رو تنظیم کن — حداقل اعلام، جوکر، امتیاز پایان.</p>
        </div>
        <div style={{ "background": "rgba(16,4,4,0.72)", "border": "1px solid rgba(232,193,105,0.32)", "borderRadius": "14px", "padding": "24px", "opacity": "0", "animation": "stepRise 0.75s cubic-bezier(0.2,0.75,0.25,1) 0.24s both, stepGlow 4.5s ease-in-out 2.20s infinite", "transition": "transform 0.35s cubic-bezier(0.2,0.75,0.25,1),border-color 0.35s,background 0.35s" }} className="hv1">
          ...
          <p style={{ "fontSize": "16px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}>لینک رو بفرست — به محض چهار نفر شدن، حراج شروع میشه.</p>
        </div>
      </div>
    ...
    <section style={{ "maxWidth": "1120px", "margin": "0 auto", "padding": "clamp(36px,5vw,56px) clamp(16px,4vw,24px)", "borderTop": "1px solid rgba(232,193,105,0.13)" }}>
      ...
      <p style={{ "fontSize": "17px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0 0 20px", "maxWidth": "680px" }}>قوانین کامل شلم رو نوشتیم — از حراج و زمین تا امتیاز کارت‌ها، سوختن، شلم کامل و همه‌ی واریانت‌ها از جمله شلم با جوکر.</p>
    ...
    <section style={{ "maxWidth": "1120px", "margin": "0 auto", "padding": "clamp(36px,5vw,56px) clamp(16px,4vw,24px)", "borderTop": "1px solid rgba(232,193,105,0.13)" }}>
      ...
      <div style={{ "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(300px,1fr))", "gap": "18px" }}>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "14px", "padding": "22px" }}>
          <p style={{ "fontSize": "16px", "color": "#e6d5b8", "lineHeight": "1.9", "margin": "0" }}><strong style={{ "color": "#f3d391" }}>حکم</strong> — شناخته‌شده‌ترین بازی ورق ایران؛ ساده‌تر شروع میشه</p>
        </div>
        <div style={{ "background": "rgba(255,255,255,0.035)", "border": "1px solid rgba(232,193,105,0.2)", "borderRadius": "14px", "padding": "22px" }}>
    ...
    <section style={{ "maxWidth": "1120px", "margin": "0 auto", "padding": "clamp(36px,5vw,56px) clamp(16px,4vw,24px) 0", "borderTop": "1px solid rgba(232,193,105,0.13)", "display": "flex", "gap": "32px", "alignItems": "flex-end", "flexWrap": "wrap" }}>
      ...
      <img src="/assets/shelem-mobile.webp" alt="مردی تکیه‌داده به پیکان با گوشی در دست" style={{ "width": "min(420px,100%)", "height": "auto", "display": "block", "marginBottom": "0", "filter": "drop-shadow(0 -10px 30px rgba(0,0,0,0.45))" }} />
    </section>
    ...
    <section style={{ "maxWidth": "1120px", "margin": "0 auto", "padding": "clamp(36px,5vw,56px) clamp(16px,4vw,24px)", "borderTop": "1px solid rgba(232,193,105,0.13)" }}>
      ...
      <div style={{ "display": "grid", "gridTemplateColumns": "repeat(auto-fit,minmax(min(320px,100%),1fr))", "gap": "26px" }}>
        ...
        <div>
          ...
          <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>شلم دقیقاً چهار نفره. اگه چهار نفر نشدین، جای خالی با حریف هوشمند پر میشه.</p>
        </div>
        <div>
          <h3 style={{ "fontSize": "17px", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 8px" }}>میشه با جوکر بازی کرد؟</h3>
          <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>بله. پیش از شروع میز می‌تونین حالت جوکر رو روشن کنین.</p>
        </div>
        <div>
          <h3 style={{ "fontSize": "17px", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 8px" }}>اگه تیم ما بسوزه چی میشه؟</h3>
          <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>عدد اعلام‌شده از امتیاز تیم کم میشه. تخته‌ی امتیاز این رو خودش اعمال می‌کنه.</p>
        </div>
        <div>
          <h3 style={{ "fontSize": "17px", "fontWeight": "700", "color": "#f2ddb4", "margin": "0 0 8px" }}>می‌تونم فقط با دوستای خودم بازی کنم؟</h3>
          <p style={{ "fontSize": "16px", "color": "#cdb797", "lineHeight": "1.95", "margin": "0" }}>بله. اتاق خصوصی بساز و کدش رو فقط برای همونا بفرست.</p>
        </div>
      </div>
    </section>
  </main>
